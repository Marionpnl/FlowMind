...
export default function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col justify-between border-r border-black/5 bg-cream p-5">
      <div>
        {/* Logo */}
      ...
      <div className="space-y-3">
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          <p className="mb-2 text-xs text-black/70 uppercase tracking-widest font-medium">
            <Flame className="h-4 w-4 inline-block text-accent-danger mr-2" />
            Streak · 12 jours
          </p>
          ...
          <div className="flex justify-between rounded-2xl pt-3 ">
